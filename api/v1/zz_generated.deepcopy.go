...
func (in *FlowStageGroup) DeepCopyInto(out *FlowStageGroup) {
	*out = *in
	in.SubgroupAlerts.DeepCopyInto(&out.SubgroupAlerts)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SubgroupAlerts) DeepCopyInto(out *SubgroupAlerts) {
	*out = *in
	if in.Alerts != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SubgroupAlerts.
func (in *SubgroupAlerts) DeepCopy() *SubgroupAlerts {
	if in == nil {
		return nil
	}
	out := new(SubgroupAlerts)
	in.DeepCopyInto(out)
	return out
}
